...
X_and_mask = np.load("/scratch/ling2/FSL-Mate/PaddleFSL/examples/molecular_property_prediction/app/X_and_mask.npy")
...
app.layout = html.Div([
    ...
    dcc.Upload(
        id='upload-data',
        children=html.Div(['Drag and drop or click to upload a CSV file (68 column of x values)']),
        style={
    ...
    html.Div(id='output'),
    dcc.Graph(id='mortality-plot'),
    html.Div(id='shap-plot'),
    html.Div(id='feature-editor'),
    html.Button("Update SHAP", id='update-shap-button', n_clicks=0),
    html.Div(id='shap-plot-updated'),
...
def predict(contents, filename):
    ...
    pred_df.columns[-1]='Over 15-year Mortality'
